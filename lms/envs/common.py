...
OAUTH2_PROVIDER_APPLICATION_MODEL = 'oauth_dispatch.RestrictedApplication_2' 
...
DEFAULT_JWT_ISSUER = 'change-me-issuer-1',
DEFAULT_RESTRICTED_JWT_ISSUER = 'change-me-issuer-2'
...
JWT_AUTH = {
    ...
    'JWT_ISSUERS': [
        {
            'ISSUER':'change-me-issuer-1',
            'SECRET_KEY':'change-me-secret-key-1',
            'AUDIENCE':'set-me-audience-1',
        },
        {
            'ISSUER':'change-me-issuer-2',
            'SECRET_KEY':'change-me-secret-key-2',
            'AUDIENCE':'set-me-audience-2',
        }
    ]
}
